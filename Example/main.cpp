...
#ifdef __APPLE__
/// Use these while on a Mac. Don't forget to send the compiler flag `-framework Accelerate`.
///
...
/// Use this with Intel oneMKL. Please check their documentation if you are unsure.
