...
namespace Repulsor
{
    ...
    public:
        ...
        using Inter_Pattern_T    = Sparse::BinaryMatrixCSR<Int,LInt,Parallel>;
        using VeryNear_Pattern_T = Sparse::BinaryMatrixCSR<Int,LInt,Parallel>;
        using Near_Pattern_T     = Sparse::BinaryMatrixCSR<Int,LInt,Parallel>;
        using Far_Pattern_T      = Sparse::BinaryMatrixCSR<Int,LInt,Parallel>;
