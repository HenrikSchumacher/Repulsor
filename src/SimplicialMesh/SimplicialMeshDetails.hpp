		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					buffer__[4*i+3] = charge*(P_D_far__[15*i+4] + P_D_near__[15*i+4]);
			},
			simplices.Dimension(0),
			ThreadCount()
		);
		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					const Real s35 = P_D_far__[6*i+0];
					const Real s36 = P_D_near__[8*i+0];
					const Real s37 = P_D_near__[8*i+1];
					const Real s38 = P_D_near__[8*i+3];
					const Real s39 = P_D_far__[6*i+1];
					const Real s40 = s0 + s2;
					const Real s41 = P_D_near__[8*i+4];
					const Real s42 = P_D_far__[6*i+4];
					const Real s43 = P_D_near__[8*i+6];
					const Real s44 = -(s14*s3*s9);
					const Real s45 = s12*s3;
					const Real s46 = s44 + s45;
					const Real s47 = P_D_far__[6*i+2];
					const Real s48 = s5 + s7;
					const Real s49 = s11/2.;
					const Real s50 = P_D_near__[8*i+2];
					const Real s51 = P_D_far__[6*i+3];
					const Real s52 = P_D_near__[8*i+5];
					const Real s53 = -2*s14*s4*s8;
					const Real s54 = -(s12*s27*s8);
					const Real s55 = s53 + s54;
					const Real s56 = P_D_far__[6*i+5];
					const Real s57 = s8*s9;
					const Real s58 = P_D_near__[8*i+7];
					...
					buffer__[4*i+0] = charge*(-(s12*s3*s35) - s12*s3*s36 + (s11 - s0*s12*s3)*s37 - s12*s2*s3*s38 + s17*s42 + s17*s43 - (s12*s3*s47*s48)/2. + s39*(-0.5*(s12*s3*s40) + s49) - s12*s3*s5*s50 + s29*s51 + s29*s52 + s34*s56 + s34*s58 - s12*s3*s41*s7);
					buffer__[4*i+1] = charge*(s42*s46 + s43*s46 + s51*s55 + s52*s55 + s56*s64 + s58*s64 - s12*s35*s8 - s12*s36*s8 - s0*s12*s37*s8 - s12*s2*s38*s8 - (s12*s39*s40*s8)/2. - s12*s41*s7*s8 + s47*(s49 - (s12*s48*s8)/2.) + s50*(s11 - s12*s5*s8));
					buffer__[4*i+2] = charge*(s12*s3*s35 + s12*s3*s36 + s0*s12*s3*s37 + (s11 + s12*s2*s3)*s38 + (s12*s3*s47*s48)/2. + s39*((s12*s3*s40)/2. + s49) + s12*s3*s5*s50 + s42*s67 + s43*s67 + s12*s3*s41*s7 + s51*s73 + s52*s73 + s56*s76 + s58*s76);
					buffer__[4*i+3] = charge*(s42*s79 + s43*s79 + s12*s35*s8 + s12*s36*s8 + s0*s12*s37*s8 + s12*s2*s38*s8 + (s12*s39*s40*s8)/2. + s12*s5*s50*s8 + s47*(s49 + (s12*s48*s8)/2.) + s41*(s11 + s12*s7*s8) + s51*s82 + s52*s82 + s56*s88 + s58*s88);
			},
			simplices.Dimension(0),
			ThreadCount()
		);
		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					const Real s48 = P_D_far__[10*i+6];
					const Real s49 = P_D_near__[13*i+9];
					const Real s50 = P_D_far__[10*i+0];
					const Real s51 = P_D_near__[13*i+0];
					const Real s52 = P_D_near__[13*i+1];
					const Real s53 = P_D_near__[13*i+3];
					const Real s54 = P_D_near__[13*i+4];
					const Real s55 = P_D_far__[10*i+1];
					const Real s56 = s0 + s2;
					const Real s57 = P_D_near__[13*i+5];
					const Real s58 = P_D_near__[13*i+6];
					const Real s59 = P_D_far__[10*i+3];
					const Real s60 = s10 + s12;
					const Real s61 = P_D_far__[10*i+5];
					const Real s62 = P_D_near__[13*i+8];
					const Real s63 = -(s18*s3*s9);
					const Real s64 = s19*s3;
					const Real s65 = s63 + s64;
					const Real s66 = P_D_far__[10*i+8];
					const Real s67 = P_D_near__[13*i+11];
					const Real s68 = -(s13*s18*s9);
					const Real s69 = s24 + s68;
					const Real s70 = P_D_far__[10*i+2];
					const Real s71 = s5 + s7;
					const Real s72 = s16/2.;
					const Real s73 = P_D_near__[13*i+2];
					const Real s74 = P_D_far__[10*i+4];
					const Real s75 = P_D_near__[13*i+7];
					const Real s76 = -2*s18*s4*s8;
					const Real s77 = -(s19*s35*s8);
					const Real s78 = s76 + s77;
					const Real s79 = P_D_far__[10*i+7];
					const Real s80 = s8*s9;
					const Real s81 = P_D_near__[13*i+10];
					...
					const Real s88 = P_D_far__[10*i+9];
					const Real s89 = P_D_near__[13*i+12];
					...
					buffer__[6*i+0] = charge*(s25*s48 + s25*s49 - s19*s3*s50 - s19*s3*s51 + (s16 - s0*s19*s3)*s52 - s10*s19*s3*s53 - s19*s2*s3*s54 - s12*s19*s3*s58 - (s19*s3*s59*s60)/2. + s22*s61 + s22*s62 - s19*s3*s57*s7 - (s19*s3*s70*s71)/2. + s55*(-0.5*(s19*s3*s56) + s72) - s19*s3*s5*s73 + s37*s74 + s37*s75 + s42*s79 - s13*s18*s3*s66*s8 - s13*s18*s3*s67*s8 + s42*s81 + s47*s88 + s47*s89);
					buffer__[6*i+1] = charge*(s61*s65 + s62*s65 + s66*s69 + s67*s69 + s74*s78 + s75*s78 - s13*s18*s3*s48*s8 - s13*s18*s3*s49*s8 - s19*s50*s8 - s19*s51*s8 - s0*s19*s52*s8 - s10*s19*s53*s8 - s19*s2*s54*s8 - (s19*s55*s56*s8)/2. - s12*s19*s58*s8 - (s19*s59*s60*s8)/2. - s19*s57*s7*s8 + s73*(s16 - s19*s5*s8) + s70*(s72 - (s19*s71*s8)/2.) + s79*s87 + s81*s87 + s88*s92 + s89*s92);
					buffer__[6*i+2] = charge*(-(s13*s19*s50) - s13*s19*s51 - s0*s13*s19*s52 + (s16 - s10*s13*s19)*s53 - s13*s19*s2*s54 - (s13*s19*s55*s56)/2. - s12*s13*s19*s58 - s13*s19*s57*s7 - (s13*s19*s70*s71)/2. + s59*(-0.5*(s13*s19*s60) + s72) - s13*s19*s5*s73 + s102*s79 - s13*s18*s3*s61*s8 - s13*s18*s3*s62*s8 + s102*s81 + s109*s88 + s109*s89 + s48*s94 + s49*s94 + s66*s96 + s67*s96 + s74*s99 + s75*s99);
					buffer__[6*i+3] = charge*(s115*s48 + s115*s49 + s19*s3*s50 + s19*s3*s51 + s0*s19*s3*s52 + s10*s19*s3*s53 + (s16 + s19*s2*s3)*s54 + s12*s19*s3*s58 + (s19*s3*s59*s60)/2. + s112*s61 + s112*s62 + s19*s3*s57*s7 + (s19*s3*s70*s71)/2. + s55*((s19*s3*s56)/2. + s72) + s19*s3*s5*s73 + s121*s74 + s121*s75 + s124*s79 + s13*s18*s3*s66*s8 + s13*s18*s3*s67*s8 + s124*s81 + s127*s88 + s127*s89);
					buffer__[6*i+4] = charge*(s130*s61 + s130*s62 + s132*s66 + s132*s67 + s135*s74 + s135*s75 + s141*s79 + s13*s18*s3*s48*s8 + s13*s18*s3*s49*s8 + s19*s50*s8 + s19*s51*s8 + s0*s19*s52*s8 + s10*s19*s53*s8 + s19*s2*s54*s8 + (s19*s55*s56*s8)/2. + s12*s19*s58*s8 + (s19*s59*s60*s8)/2. + s19*s5*s73*s8 + s57*(s16 + s19*s7*s8) + s70*(s72 + (s19*s71*s8)/2.) + s141*s81 + s144*s88 + s144*s89);
					buffer__[6*i+5] = charge*(s146*s48 + s146*s49 + s13*s19*s50 + s13*s19*s51 + s0*s13*s19*s52 + s10*s13*s19*s53 + s13*s19*s2*s54 + (s13*s19*s55*s56)/2. + (s16 + s12*s13*s19)*s58 + s148*s66 + s148*s67 + s13*s19*s57*s7 + (s13*s19*s70*s71)/2. + s59*((s13*s19*s60)/2. + s72) + s13*s19*s5*s73 + s151*s74 + s151*s75 + s154*s79 + s13*s18*s3*s61*s8 + s13*s18*s3*s62*s8 + s154*s81 + s160*s88 + s160*s89);
			},
			simplices.Dimension(0),
			ThreadCount()
		);
		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					const Real s61 = P_D_far__[15*i+7];
					const Real s62 = P_D_near__[19*i+11];
					const Real s63 = P_D_far__[15*i+8];
					const Real s64 = P_D_near__[19*i+12];
					const Real s65 = P_D_far__[15*i+13];
					const Real s66 = P_D_near__[19*i+17];
					const Real s67 = P_D_far__[15*i+0];
					const Real s68 = P_D_near__[19*i+0];
					const Real s69 = P_D_near__[19*i+1];
					const Real s70 = P_D_near__[19*i+3];
					const Real s71 = P_D_near__[19*i+4];
					const Real s72 = P_D_near__[19*i+5];
					const Real s73 = P_D_far__[15*i+1];
					const Real s74 = s0 + s2;
					const Real s75 = P_D_near__[19*i+6];
					const Real s76 = P_D_near__[19*i+7];
					const Real s77 = P_D_far__[15*i+3];
					const Real s78 = s10 + s12;
					const Real s79 = P_D_near__[19*i+8];
					const Real s80 = P_D_far__[15*i+4];
					const Real s81 = s15 + s17;
					const Real s82 = P_D_far__[15*i+6];
					const Real s83 = P_D_near__[19*i+10];
					const Real s84 = -(s23*s3*s9);
					const Real s85 = s24*s3;
					const Real s86 = s84 + s85;
					const Real s87 = P_D_far__[15*i+10];
					const Real s88 = P_D_near__[19*i+14];
					const Real s89 = -(s13*s23*s9);
					const Real s90 = s29 + s89;
					const Real s91 = P_D_far__[15*i+11];
					const Real s92 = P_D_near__[19*i+15];
					const Real s93 = -(s18*s23*s9);
					const Real s94 = s32 + s93;
					const Real s95 = P_D_far__[15*i+2];
					const Real s96 = s5 + s7;
					const Real s97 = s21/2.;
					const Real s98 = P_D_near__[19*i+2];
					const Real s99 = P_D_far__[15*i+5];
					const Real s100 = P_D_near__[19*i+9];
					const Real s101 = -2*s23*s4*s8;
					const Real s102 = -(s24*s43*s8);
					const Real s103 = s101 + s102;
					const Real s104 = P_D_far__[15*i+9];
					const Real s105 = s8*s9;
					const Real s106 = P_D_near__[19*i+13];
					...
					const Real s112 = s110 + s111;
					const Real s113 = P_D_far__[15*i+12];
					const Real s114 = P_D_near__[19*i+16];
					const Real s115 = -2*s14*s23*s8;
					const Real s116 = -(s24*s53*s8);
					const Real s117 = s115 + s116;
					const Real s118 = P_D_far__[15*i+14];
					const Real s119 = P_D_near__[19*i+18];
		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					const Real s61 = P_D_far__[10*i+7];
					const Real s62 = P_D_near__[16*i+13];
					const Real s63 = -s16;
					...
					const Real s70 = P_D_far__[10*i+0];
					const Real s71 = P_D_near__[16*i+0];
					const Real s72 = P_D_near__[16*i+1];
					const Real s73 = P_D_near__[16*i+3];
					const Real s74 = P_D_near__[16*i+4];
					const Real s75 = P_D_near__[16*i+5];
					const Real s76 = P_D_near__[16*i+6];
					const Real s77 = P_D_near__[16*i+7];
					const Real s78 = P_D_far__[10*i+1];
					const Real s79 = s14 + s15 + s16;
					const Real s80 = P_D_near__[16*i+8];
					const Real s81 = P_D_near__[16*i+9];
					const Real s82 = P_D_far__[10*i+3];
					const Real s83 = s0 + s4 + s9;
					const Real s84 = P_D_far__[10*i+9];
					const Real s85 = P_D_near__[16*i+15];
					const Real s86 = -0.25*(s24*s36*s69);
					const Real s87 = s23*s44*s64;
					const Real s88 = s86 + s87;
					const Real s89 = P_D_far__[10*i+8];
					const Real s90 = P_D_near__[16*i+14];
					const Real s91 = -0.25*(s23*s31*s36*s69);
					const Real s92 = (s31*s44*s64)/2.;
					const Real s93 = s91 + s92;
					const Real s94 = P_D_far__[10*i+5];
					const Real s95 = P_D_near__[16*i+11];
					const Real s96 = -0.25*(s12*s31*s36*s69);
					const Real s97 = (s31*s44*s67)/2.;
					const Real s98 = s96 + s97;
					const Real s99 = P_D_far__[10*i+6];
					const Real s100 = P_D_near__[16*i+12];
					...
					const Real s105 = P_D_far__[10*i+4];
					const Real s106 = P_D_near__[16*i+10];
					const Real s107 = -0.25*(s13*s36*s69);
					const Real s108 = s12*s44*s67;
					const Real s109 = s107 + s108;
					const Real s110 = P_D_far__[10*i+2];
					const Real s111 = s1 + s3 + s6;
					const Real s112 = s34/6.;
					const Real s113 = P_D_near__[16*i+2];
		...
		ParallelDo(
			[=,this]( const Int i )
			{
				...
				charge *= nth;
					...
					const Real s432 = P_D_near__[23*i+1];
					const Real s433 = P_D_near__[23*i+3];
					const Real s434 = P_D_near__[23*i+4];
					const Real s435 = P_D_near__[23*i+5];
					const Real s436 = P_D_near__[23*i+6];
					const Real s437 = P_D_near__[23*i+7];
					const Real s438 = P_D_near__[23*i+8];
					const Real s439 = P_D_near__[23*i+9];
					const Real s440 = P_D_far__[15*i+1];
					const Real s441 = s2 + s3 + s9;
					const Real s442 = P_D_near__[23*i+10];
					const Real s443 = P_D_near__[23*i+11];
					const Real s444 = P_D_far__[15*i+3];
					const Real s445 = s10 + s14 + s4;
					const Real s446 = P_D_near__[23*i+12];
					const Real s447 = P_D_far__[15*i+4];
					...
					const Real s465 = P_D_near__[23*i+13];
					...
					const Real s506 = P_D_near__[23*i+17];
