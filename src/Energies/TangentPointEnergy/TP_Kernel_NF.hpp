...
namespace Repulsor
{
    ...
    >
    class TP_Kernel_NF : public FMM_Kernel_NF<
    ...
    public:
        ...
        TP_Kernel_NF( mref<Configurator_T> conf, const Int thread_, const T1 q_half_, const T2 p_half_ )
        :   Base_T               (conf,thread_)
        ,   q                    (two*q_half_)
        ,   q_half               (q_half_    )
        ...
        TP_Kernel_NF( mref<TP_Kernel_NF> other, const Int thread_ )
...
//                jj_block.SetZero();
    ...
    public:
        ...
        {
            return std::string("TP_Kernel_NF<")
            + ToString(S_DOM_DIM) + ","
            + ToString(T_DOM_DIM) + ","
//            + this->S.ClassName() + ","
            + "...,"
