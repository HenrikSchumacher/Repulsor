        ...
        switch(dom_dim)
        {
            ...
            case 1:
            {
                switch(amb_dim)
                {
                    ...
                    case 2:
                    {
                        r = new CLASS<1,2,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_3D == 1
                    case 3:
                    {
                        r = new CLASS<1,3,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_4D == 1
                    case 4:
                    {
                        r = new CLASS<1,4,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
                    default:
            ...
            case 2:
            {
                switch(amb_dim)
                {
                    ...
                    case 3:
                    {
                        r = new CLASS<2,3,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_4D == 1
                    case 4:
                    {
                        r = new CLASS<2,4,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
                    default:
            ...
            case 0:
            {
                switch(amb_dim)
                {
                    ...
                    case 1:
                    {
                        r = new CLASS<0,1,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_2D == 1
                    case 2:
                    {
                        r = new CLASS<0,2,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_3D == 1
                    case 3:
                    {
                        r = new CLASS<0,3,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
#if ENABLE_4D == 1
                    case 4:
                    {
                        r = new CLASS<0,4,Real,Int,SReal,ExtReal>(weight,q,p);
                        break;
                    }
#endif
                    default:
