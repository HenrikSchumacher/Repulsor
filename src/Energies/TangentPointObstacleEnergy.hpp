...
namespace Repulsor
{
    ...
    public:
        ...
        {
            return TOOLS_TO_STD_STRING(CLASS)+"<"+ToString(DOM_DIM_S)+","+ToString(DOM_DIM_T)+","+ToString(AMB_DIM)+","+TypeName<Real>+","+TypeName<Int>+","+TypeName<LInt>+","+TypeName<SReal>+","+TypeName<ExtReal>+"("+ToStringFPGeneral(q)+","+ToStringFPGeneral(p)+")";
        }
