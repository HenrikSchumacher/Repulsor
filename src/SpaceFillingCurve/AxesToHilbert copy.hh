...
//            {
//                Int bit_pos = nj + i;
//                Int slot    = bit_pos / bit_count;
//                Int bit     = bit_pos % bit_count;
//                
//                set_bit( h[slot], bit, get_bit( x[n-1-i], j ) );
//                
////                set_bit( h[slot], bit, get_bit( x[i], j ) );
//                
////                set_bit( h[j], i, get_bit( Y[n-1-i], j ) );
//            }
//        }
    }
